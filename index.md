...
<p align="center">
  <img src="https://github.com/zrefai/Poke-Dictionary/blob/gh-pages/gifs/searching.gif?raw=true" alt="gif 1" width="300" height="650">
</p>

### Details

<p align="center">
  <img src="https://github.com/zrefai/Poke-Dictionary/blob/gh-pages/gifs/details.gif?raw=true" alt="gif 1" width="300" height="650">
</p>

### Favorites

<p align="center">
  <img src="https://github.com/zrefai/Poke-Dictionary/blob/gh-pages/gifs/favorites.gif?raw=true" alt="gif 2" width="300" height="650">
</p>

## Technologies

[React Native](https://reactnative.dev/), [PokéAPI](https://pokeapi.co/), [Redux](https://redux.js.org/), [Redux Persist](https://github.com/rt2zz/redux-persist), [Fuse.js](https://fusejs.io/), [Axios](https://github.com/axios/axios)
...
- Every component in the details page except for the Info and Stats sections of a pokemon required a different and sometimes multiple API calls to fetch the data. Stats and Info data are available attributes in the first fetch of a pokemon's data, but this is not the case for Damage Stats, Moves List or Evolutions. Managing this was difficult at first, as each returned data structure was different in its own way and required use of smart parent components and dummy children components. This was a fun challenge as each section required its own special care and management.
- Searching was improperly implemented in the app at first. I had it so that if you didnt spell the pokemon's name correctly the first time, you would probably have to use google to get the correct spelling. My friend recommended suggestive searching to make the user experience more fluid and boy did it make a difference. A Fuzzy Search algorithm is used for searching pokemon now, brought to you by [Fuse.js](https://fusejs.io/). This is a neat library, and very easy to use.
...
<p align="center">
  <img src="https://github.com/zrefai/Poke-Dictionary/blob/gh-pages/gifs/unown.gif?raw=true" alt="gif 3" width="300" height="650">
</p>
